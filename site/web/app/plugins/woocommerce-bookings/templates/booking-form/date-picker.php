...
<fieldset class="wc-bookings-date-picker wc-bookings-date-picker-<?php echo esc_attr( $product_type ); ?> <?php echo implode( ' ', $class ); ?>">
	...
	<legend>
		...
		<span class="label"><?php echo $label; ?></span>: <small class="wc-bookings-date-picker-choose-date"><?php _e( 'Check availability and price', 'woocommerce-bookings' ); ?></small>
	</div>
	</legend>
...
<div class="row wc-bookings-date-picker-choose-date">
	...
	<div class="col-lg-5">
		...
		<label>
			<span class="datep"><input type="text" name="<?php echo $name; ?>_month" placeholder="<?php _e( 'mm', 'woocommerce-bookings' ); ?>" size="1" class="booking_date_month" /></span>
			<span class="datep"><input type="text" name="<?php echo $name; ?>_day" placeholder="<?php _e( 'dd', 'woocommerce-bookings' ); ?>" size="2" class="booking_date_day" /></span>
			<span class="datep"><input type="text" value="<?php echo date( 'Y' ); ?>" name="<?php echo $name; ?>_year" placeholder="<?php _e( 'YYYY', 'woocommerce-bookings' ); ?>" size="2" class="booking_date_year" /></span>
...
<div class="col-lg-2 icon_r_date">
<a href="#"></a>
</div>
<div class="col-lg-5">
	<?php if ( 'customer' == $duration_type && $is_range_picker_enabled ) : ?>
		<div class="wc-bookings-date-picker-date-fields">
			...
			<?php if ( $month_before_day ) : ?>
			<label>
				 <span class="datep"><input type="text" name="<?php echo $name; ?>_to_month" placeholder="<?php _e( 'mm', 'woocommerce-bookings' ); ?>" size="2" class="booking_to_date_month" /></span>
				 <span class="datep"><input type="text" name="<?php echo $name; ?>_to_day" placeholder="<?php _e( 'dd', 'woocommerce-bookings' ); ?>" size="2" class="booking_to_date_day" /></span>
				 <span class="datep"><input type="text" value="<?php echo date( 'Y' ); ?>" name="<?php echo $name; ?>_to_year" placeholder="<?php _e( 'YYYY', 'woocommerce-bookings' ); ?>" size="4" class="booking_to_date_year" /></span>
...
<?php do_action( 'woocommerce_bookings_time' ); ?>
